...
import { useUpdateQuiz } from "../../hooks/admin/useQuiz";
...
export default function EditQuizForm({
  ...
  const handleSubmit = () => {
    ...
    console.log("Modification du quiz :", {
      gameId: quiz.gameId,
      ...payload,
    });
    ...
    updateQuiz(
      ...
      },
      {
        ...
        onError: () => {
          toast.error(
            "Une erreur est survenue lors de la modification du quiz."
          );
        },
      }
    );
          ...
          <div className="flex items-center justify-between border-b border-gray-200 px-6 py-4">
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">
                Modifiez les informations générales du quiz.
              </p>
            </div>
