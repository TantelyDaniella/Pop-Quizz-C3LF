...
export default function AuthLayout() {
    ...
    return (
        <div className="relative flex flex-col md:grid md:grid-cols-2 min-h-screen overflow-hidden bg-(--bg-main)">
            ...
            {/* Glow ambiant */}
            <div className="absolute -top-60 left-1/4 w-[700px] h-[700px] rounded-full bg-primary/10 blur-[140px] pointer-events-none" />
            <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] rounded-full bg-[#00e5c4]/5 blur-[100px] pointer-events-none" />
